...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> updateWishlistPreferences() async {
    ...
    prefs.setStringList('wishlistItems', isHeartFilledList
        .asMap()
        .entries
                                      ...
                                      if (user != null) {
                                        try {
                                          await FirebaseFirestore.instance
                                            ...
                                            'vehicleType':
                                                docs[index]['vehicleType'],
                                            'licenseP{lateNum':
                                                docs[index]['licensePlateNum'],
                                            'numOfSeats':
                                                docs[index]['numSeats'],
                                            'vehicleAddress':
                                                docs[index]['renterAddress'],
                                            'hostAge':
                                                docs[index]['hostAge'],
                                            'hostMobileNumber':
                                                docs[index]['hostMobileNumber'],
                                            'email': docs[index]['email'],
                                            'hostId': docs[index]['hostId'],
                                            'bookingStatus':
                                                docs[index]['bookingStatus'],
                                            ' vehicleImageUrl':
                                                docs[index]['vehicleImage'],
                                          });
                                        } catch (e) {
